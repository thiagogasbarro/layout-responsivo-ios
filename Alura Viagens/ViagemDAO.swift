...
class ViagemDAO: NSObject {
    ...
    func retornaTodasAsViagens() -> Array<Viagem> {
        let guaruja = Viagem(titulo: "Guaruja", quantidadeDeDias: 3, preco: "1.800,59", caminhoDaImagem: "img1.png")
        ...
        let santos = Viagem(titulo: "Santos", quantidadeDeDias: 3, preco: "1.385,00", caminhoDaImagem: "img4.jpg")
        let fortaleza = Viagem(titulo: "Fortaleza", quantidadeDeDias: 4, preco: "3.120,00", caminhoDaImagem: "img5.jpg")
        let listaViagem:Array<Viagem> = [rioDeJaneiro, guaruja, interiorSaoPaulo, santos, fortaleza]
