...
class ViagemDAO: NSObject {
    ...
    func retornaTodasAsViagens() -> Array<Viagem> {
        let ceara = Viagem(titulo: "Guaruja", quantidadeDeDias: 3, preco: "1.800,59", caminhoDaImagem: "img1.png")
        ...
        let paraiba = Viagem(titulo: "Santos", quantidadeDeDias: 3, preco: "1.385,00", caminhoDaImagem: "img4.jpg")
